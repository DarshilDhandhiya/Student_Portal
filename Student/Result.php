...
$today = date("d-m-Y");
// File upload path
$targetDir = "../Photos/Uploads/Result/";
...
if(isset($_POST["submit"]) && !empty($_FILES["file"]["name"])){
    ...
    if(in_array($fileType, $allowTypes)){
		...
		$sql = "INSERT into result (file_name, uploaded_on, descc) VALUES ('$fileName','$today','$descc')";
	...
	if($result)
    {
	   ...
	   header("location: ../Faculty/Faculty_Result.php");
    }
	else
	{
		echo mysqli_error($db);
