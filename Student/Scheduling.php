...
$today = date("d-m-Y");
// File upload path
$targetDir = "../Photos/Uploads/Scheduling/";
...
if(isset($_POST["submit"]) && !empty($_FILES["file"]["name"])){
    ...
    if(in_array($fileType, $allowTypes)){
		...
		$sql = "INSERT into scheduling (file_name, uploaded_on, descc, link) VALUES ('$fileName','$today','$descc','$link')";
	...
	if($result)
    {
	   ...
	   header("location: ../Faculty/Faculty_Scheduling.php");
    }
	else
	{
		echo mysqli_error($db);
