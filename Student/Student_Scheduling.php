  ...
  <!-- Header section end -->
    ...
    <center>
      ...
      <?php
        ...
        $records = mysqli_query($db,"SELECT * FROM Scheduling ORDER BY id DESC;");
        while($data = mysqli_fetch_array($records))
        {
          $imageURL = '../Photos/Uploads/Scheduling/'.$data['file_name']; 
          $id = $data['id'];
          $descc = $data['descc'];
          $link = $data['link'];
          ?>
...
?></p>
     ...
     <?php   } ?>
        ...
        <?php
          ...
          {  
            $id = $data['id'];
            $imageURL2 = '../Photos/Uploads/Scheduling/'.$data['file_name'];
			$descc = $data['descc'];
			$link = $data['link'];
