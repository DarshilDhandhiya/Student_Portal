...
<body>
    <div class="container row login-box">
        ...
        <div class="Login">
            Already Have An Account <a href="Student_Login.php">Login.</a><br><br>
            ...
            <form action="Ragistration.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="number" name="Enrollment" placeholder="Enrollment" required/>
                    ...
                    <select name="Branch" id="Branch" required>
                        ...
                        <option value="Civil-Diploma"> Civil-Diploma </option>
                        <option value="IT-Diploma"> IT-Diploma </option>
                        <option value="Computer-Degree"> Computer-Degree </option>
                        <option value="Mechanical-Degree"> Mechanical-Degree </option>
                        <option value="Civil-Degree"> Civil-Degree </option>
                        <option value="IT-Degree"> IT-Degree </option>
                    </select>
