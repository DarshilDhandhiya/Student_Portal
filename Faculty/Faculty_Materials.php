...
<!-- Upload  -->
<h2>Material Upload</h2><br><br>
<form id="file-upload-form" class="uploader" action="../Student/Material.php" method="post" enctype="multipart/form-data">
